...
_displayDialog(context);
            ...
            ElevatedButton.icon(
                  onPressed: () async {
                      ...
                      String r=StorageUtil.getString("uuid");
                        ...
                        String u1="https://kit.rtirl.com/api/$uuid/obsRecording";
                        String u2="https://kit.rtirl.com/api/$uuid/stopRecording";    
                       // print(u);
                          Uri uri = Uri.parse(u);
 ...
 Response res = await http.post(uri2,
   ...
   ,)
                   ...
                   String r=StorageUtil.getString("uuid");
                        ...
                        String u1="https://kit.rtirl.com/api/$uuid/obsRecording";
                        String u2="https://kit.rtirl.com/api/$uuid/unpauseRecording";    
                       // print(u);
                          Uri uri = Uri.parse(u);
                          Uri uri1=Uri.parse(u1);
                          Uri uri2=Uri.parse(u2);
 ...
 Response res = await http.post(uri,
                    ...
                    icon: const Icon(
                        Icons.pause), //icon data for elevated button
      ...
      ElevatedButton.icon(
                    ...
                    onPressed: () async {
                        ...
                        String u1="https://kit.rtirl.com/api/$uuid/obsVirtualcam";
                        String u2="https://kit.rtirl.com/api/$uuid/stopVirtualcam";    
                       // print(u);
                          Uri uri = Uri.parse(u);
                          Uri uri1=Uri.parse(u1);
                          Uri uri2=Uri.parse(u2);
 ...
 return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: const Text("Are you sure you want to start/stop streaming"),
